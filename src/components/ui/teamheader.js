            ...
            <div className="container__oo_inner">
              <div className="header__team_oo">
                <div className="hhdtcu">
                  ...
                  <img src={club.WikipediaLogoUrl} className="logo__team_header_oo"></img>
            ...
            <div className="link_link_yytsi">
              ...
              <nav className="beyucp">
                <ul className="oo_list_items__header">
                  ...
                  <li className="li__oopw"><Link to={`/soccer/team/${clubId}/${inputValue}/${club.Name}`} className="a__aa_team"><span>Home</span></Link></li>
                  <li className="li__oopw"><Link to={`/soccer/team/${clubId}/${inputValue}/fixtures`} className="a__aa_team"><span>Fixtures</span></Link></li>
                  <li className="li__oopw"><Link to={`/soccer/team/${clubId}/${inputValue}/squads`} className="a__aa_team"><span>Squads</span></Link></li>
                  <li className="li__oopw"><Link to={`/soccer/team/${clubId}/${inputValue}/${club.Name}/playerstats`} className="a__aa_team"><span>Stats</span></Link></li>
                  <li className="li__oopw"><Link className="a__aa_team"><span></span></Link></li>
